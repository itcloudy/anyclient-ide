...
export default function FileUnknown(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        fill='#8a8a8a'
      ></path>
      <path d='M512 744m-32 0a32 32 0 1 0 64 0 32 32 0 1 0-64 0Z' p-id='2183' fill='#8a8a8a'></path>
    </svg>
  );
}
