...
export default function FileKey1(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        fill='#D25B1F'
      ></path>
      <path d='M657.6 0v233.6c0 25.6 17.6 92.8 97.6 92.8H960L657.6 0z' fill='#FFFFFF' p-id='14347'></path>
      <path
